...
/**
 * @brief EchoEar I2C GPIO defineation
 *
 */
...
/**
 * @brief EchoEar SDMMC GPIO defination
 *
 */
#define FUNC_SDMMC_EN   (1)
#define SDMMC_BUS_WIDTH (1)
#define GPIO_SDMMC_CLK  (GPIO_NUM_16)
...
/**
 * @brief EchoEar SDSPI GPIO definationv
 *
 */
...
/**
 * @brief EchoEar I2S GPIO defination (PCB v1.2)
 *
 */
#define FUNC_I2S_EN         (1)
#define GPIO_I2S_LRCK       (GPIO_NUM_39)
#define GPIO_I2S_MCLK       (GPIO_NUM_42)
#define GPIO_I2S_SCLK       (GPIO_NUM_40)
#define GPIO_I2S_SDIN       (GPIO_NUM_3)   // DIN_2 for PCB v1.2
#define GPIO_I2S_DOUT       (GPIO_NUM_41)

/**
 * @brief EchoEar I2S GPIO defination
 *
 */
...
/**
 * @brief EchoEar power control IO (PCB v1.2)
 * PA_PIN for v1.2 is GPIO_NUM_15
 */
#define FUNC_PWR_CTRL       (1)
#define GPIO_PWR_CTRL       (GPIO_NUM_15)
